...
* **Barra de Progresso:** Visualização do quanto falta para atingir a meta mensal de arrecadação.
* **Lista de Prioridades:** Itens que a comunidade mais precisa no momento (Ex: Arroz, Feijão, Óleo).
* **Transparência:** Informações sobre datas de entrega das cestas e coleta no local.

## 🛠️ Tecnologias
* **IDE:** Android Studio
* **Linguagem:** Kotlin/Java
* **Interface:** XML (ProgressBar e RecyclerView)

---
**Desenvolvido por:** Bruna dos Santos Gonçalves  
**Ano:** 2026
